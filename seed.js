...
    // Top-Level Categories (All defined here)
    const globalDesserts = await createNode("Global Desserts"); // <-- New Category
...
    // --- NEW CATEGORY HIERARCHY FOR GLOBAL DESSERTS ---
    const iceCream = await createNode("Ice Cream", globalDesserts); 
    await createNode("Gelato", iceCream, "item", { 
      vendors: [
        { name: "Ben & Jerry's", url: "https://www.benandjerrys.com" },
        { name: "Haagen-Dazs", url: "https://www.haagen-dazs.com" },
      ],
    });
